function validate() {
    ...
    if (!exp.test(enterprise_name) && enterprise_name == "") {
    ...
    if(!exp.test(enterprise_password) && enterprise_password == ""){
    ...
    //地址
	 ...
	 if (!exp.test(enterprise_address) && enterprise_address == "") {
    ...
    if (!exp.test(enterprise_tel) && enterprise_tel == "") {
    ...
    if (!exp.test(enterprise_manager) && enterprise_manager == "") {
