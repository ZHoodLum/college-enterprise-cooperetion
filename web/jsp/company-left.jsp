...
<div class="container">
    <div class="leftsidebar_box">
        ...
        <dl class="cloud">
            <dt><img src="../images/left/select_xl01.png">
                <%--<a href="${pageContext.request.contextPath}/EnterpriseStudentQueryAllServlet02?pageNo=1&pageSize=1&enterpriseId=${sessionScope.EnterpriseInfo.getEnterpriseId()}" target="right">评判学生成绩</a>--%>
                <a href="${pageContext.request.contextPath}/EnterpriseStudentQueryAllServlet02?pageNo=1&enterpriseId=${sessionScope.EnterpriseInfo.getEnterpriseId()}" target="right">评判学生成绩</a>
            </dt>
            <dd class="first_dd"></dd>
            <dd class="first_dd" style="height: 10px;"></dd>
        </dl>
        ...
        <dl class="source" style="position:absolute;bottom: 50px;width: 100%">
            <dt><img src="../images/left/select_xl01.png">
                <a href="${pageContext.request.contextPath}/LogoutServlet" target="">注销</a>
            </dt>
            <%--<dd class="first_dd"></dd>--%>
            <%--<dd class="first_dd" style="height: 10px;"></dd>--%>
        </dl>
