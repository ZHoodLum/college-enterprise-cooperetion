...
<div class="container">
    <div class="leftsidebar_box">
        ...
        <dl class="app">
            <dt><img src="../images/left/select_xl01.png">
                <a href="${pageContext.request.contextPath}/StudentQueryAllServlet?pageNo=1&pageSize=1&enterpriseId=${sessionScope.EnterpriseInfo.getEnterpriseId()}" target="right">查询学生信息</a>
            </dt>
            <dd class="first_dd"></dd>
            <dd class="first_dd" style="height: 10px;"></dd>
        </dl>
