...
<div id="loginmodal"   style="overflow-y:auto;">
  ...
  <form id="myform" name="myform" action="${pageContext.request.contextPath}/InsertEnterpriseInfoServlet" method="post" onsubmit="return validate()">
    <div class="main">
      <ul>
        <li class="first">
          <h3>企业账号：</h3>
        ...
        <li class="first">
          <h3>企业名称：</h3>
          <p>
            <input type="text" id="enterprise_name" name="enterprise_name" placeholder="请填写贵公司名称！"/>
        ...
        <li>
          <h3>密码：</h3>
          <p>
            <input type="password" id="enterprise_password" name="enterprise_password" placeholder="请填写您的密码！"
        ...
        <li>
          <h3>确认密码：</h3>
          <p>
            <input type="password" id="enterprise_repassword" name="enterprise_repassword" placeholder="请填写再次确认您的密码！" value="12345678"/>
        ...
        <li>
          <h3>地址：</h3>
          <p>
            <input type="text" id="enterprise_address" name="enterprise_address" placeholder="请填写贵公司的所在地址！"/>
        ...
        <li>
          <h3>电话：</h3>
          <p>
            <input type="text" id="enterprise_tel" name="enterprise_tel" placeholder="请填写贵公司的电话！"/>
        ...
        <li>
          <h3>账号管理者：</h3>
          <p>
            <input type="text" id="enterprise_manager" name="enterprise_manager" placeholder="请填写此账号的账号管理者名！"/>
